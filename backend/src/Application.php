...
class Application extends BaseApplication implements AuthenticationServiceProviderInterface, AuthorizationServiceProviderInterface
{
    ...
    /**
     * Returns a service provider instance for creating the Authentication service.
     *
     * @param \Psr\Http\Message\ServerRequestInterface $request The request to get authentication service for.
    ...
    public function getAuthenticationService(ServerRequestInterface $request): AuthenticationServiceInterface
    {
        ...
        $service->loadAuthenticator('Authentication.Form', [
            ...
            'loginUrl' => '/api/login', // L'URL de connexion pour l'API
        ]);
        
        // Charger l'authentification JWT
    ...
    /**
     * Returns a service provider instance for creating the Authorization service.
     *
    ...
    public function getAuthorizationService(ServerRequestInterface $request): AuthorizationServiceInterface
    {
        $resolver = new MapResolver([
            // Define authorization policies for your entities/controllers here
