<template>
  <div class="p-4">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
      <h1 class="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Inventaire Équipements</h1>
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      ...
      >
        ...
        <div class="p-4 flex-1 flex flex-col">
          <h3 class="font-bold text-gray-800 mb-1 truncate" :title="item.name">{{ item.name }}</h3>
          ...
          <div class="mt-auto space-y-2">
            <div class="flex items-center text-sm text-gray-600">
              <font-awesome-icon icon="map-marker-alt" class="w-4 mr-2 text-gray-400" />
