<template>
  <div class="p-4">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
      <h1 class="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Gestion des Équipements & EPI</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      <div class="bg-white rounded-lg shadow p-4 border-l-4 border-blue-500">
        <div class="flex justify-between items-start">
          <div>
            <p class="text-gray-500 text-sm font-medium">Total Équipements</p>
            <h3 class="text-2xl font-bold text-gray-800 mt-1">{{ store.equipmentList.length }}</h3>
          </div>
      ...
      <div class="bg-white rounded-lg shadow p-4 border-l-4 border-green-500">
        <div class="flex justify-between items-start">
          <div>
            ...
            <h3 class="text-2xl font-bold text-gray-800 mt-1">{{ availableCount }}</h3>
          </div>
      ...
      <div class="bg-white rounded-lg shadow p-4 border-l-4 border-orange-500">
        <div class="flex justify-between items-start">
          <div>
            ...
            <h3 class="text-2xl font-bold text-gray-800 mt-1">{{ maintenanceCount }}</h3>
          </div>
      ...
      <div class="bg-white rounded-lg shadow p-4 border-l-4 border-red-500">
        <div class="flex justify-between items-start">
          <div>
            <p class="text-gray-500 text-sm font-medium">EPI Expirés / À contrôler</p>
            <h3 class="text-2xl font-bold text-gray-800 mt-1">{{ expiredCount }}</h3>
          </div>
    ...
    <!-- Categories Grid -->
    <h2 class="text-xl font-semibold text-gray-800 mb-4">Parcourir par catégorie</h2>
    ...
    <div v-else class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
      <div
        ...
        :key="category.id"
        class="bg-white rounded-lg shadow hover:shadow-md transition-shadow cursor-pointer p-4 border border-gray-100"
      ...
      >
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">{{ category.equipment_count || 0 }} éléments</p>
          </div>
        </div>
      </div>
      ...
      <!-- Add Category Card -->
      <div
        class="border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center p-4 cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-colors min-h-[80px]"
        @click="openCategoryDialog"
      >
        <font-awesome-icon icon="plus" class="text-gray-400 text-xl mb-2" />
        <span class="text-gray-500 font-medium text-sm">Nouvelle catégorie</span>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="bg-white rounded-lg shadow p-4">
        ...
        <div v-if="expiredEquipment.length === 0" class="text-center py-8 text-gray-500">
