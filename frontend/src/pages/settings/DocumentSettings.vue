    ...
    <div class="p-6 border rounded-lg bg-gray-50">
        ...
        <div class="flex flex-col gap-4">
            <div class="field">
                ...
                <InputText id="basePath" v-model="settings.document_base_path" placeholder="ex: documents"
                    class="w-full" />
                <small class="text-gray-500">Dossier où seront stockés les fichiers (relatif à
                    storage/app/public)</small>
            </div>
            ...
            <div class="field">
                ...
                <InputText id="namingConvention" v-model="settings.document_naming_convention"
                    placeholder="ex: {date}_{original_name}" class="w-full" />
        ...
        <div class="flex justify-end mt-6 pt-4 border-t">
            <Button label="Enregistrer les modifications" icon="pi pi-save" @click="saveSettings" :loading="loading" />
        </div>
    </div>
</template>
