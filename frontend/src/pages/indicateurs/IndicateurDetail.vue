            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="flex items-center gap-3">
                        ...
                        <div v-if="indicator?.indicator_category"
                    ...
                    <template #content>
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex items-center gap-2 mt-2">
                                <Tag :severity="getTrendSeverity(indicator.trend_direction)"
                                    :value="getTrendLabel(indicator.trend_direction)" />
                                <span class="text-sm text-gray-500 dark:text-gray-400">Cible: {{ indicator.target_value
                                    }} {{ indicator.unit }}</span>
                            </div>
                        </div>
                    </template>
                    ...
                    <template #content>
                        <form @submit.prevent="submitValue" class="flex flex-col gap-4">
                            <div class="flex flex-col gap-2">
                                ...
                                <DatePicker v-model="newValue.date" dateFormat="dd/mm/yy" showIcon fluid
                                    inputId="date" />
                            </div>

                            <div class="flex flex-col gap-2">
                                <label for="value" class="text-sm font-medium text-gray-700">Valeur ({{ indicator.unit
                                    }})</label>
                                <InputNumber v-model="newValue.value" :minFractionDigits="0" :maxFractionDigits="2"
                                    inputId="value" fluid />
                            </div>
                        ...
                        <div class="flex flex-col gap-3 text-sm">
                            ...
                            <div v-if="indicator.manager" class="mt-2 pt-2 border-t border-gray-100">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-medium">{{ indicator.manager.first_name }} {{
                                        indicator.manager.last_name }}</span>
                                </div>
                            </div>
                        </div>
                    </template>
