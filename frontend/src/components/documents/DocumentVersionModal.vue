<template>
    <Dialog :visible="visible" @update:visible="$emit('update:visible', $event)" modal header="Nouvelle Version"
        ...
        <div class="flex flex-col gap-6">
            <div class="bg-blue-50 p-4 rounded-md border border-blue-200">
                <div class="flex items-start">
                    ...
                    <div>
                        <p class="text-sm text-blue-700 m-0 font-semibold">Version actuelle : {{ currentVersion }}</p>
            ...
            <form @submit.prevent="onSubmit" class="flex flex-col gap-6">
                ...
                <div class="field">
                    ...
                    <FileUpload name="file" :auto="true" :customUpload="true" @uploader="onFileSelect"
                ...
                <!-- Version -->
                <div class="field">
                    <label for="version" class="block text-sm font-medium mb-2 text-gray-700">Numéro de version
                        *</label>
                    <InputText id="version" v-model="formData.version" placeholder="Ex: 1.1" class="w-full"
                ...
                <!-- Changelog -->
                <div class="field">
                    <label for="changelog" class="block text-sm font-medium mb-2 text-gray-700">Commentaire
                        (Changelog)</label>
                    <Textarea id="changelog" v-model="formData.changelog"
                        placeholder="Décrivez les changements apportés dans cette version..." rows="4" class="w-full" />
                </div>
