<template>
    <div class="icon-picker">
        <div ref="triggerRef" class="flex items-center gap-2 p-2 border rounded cursor-pointer hover:bg-gray-50"
            @click="toggleOverlay" :class="{ 'border-blue-500 ring-2 ring-blue-200': isOpen }">
        ...
        <Teleport to="body">
            <div v-if="isOpen">
                ...
                <!-- Dropdown -->
                <div class="fixed z-[9999] bg-white border rounded shadow-lg p-3 max-h-60 overflow-y-auto"
                    :style="dropdownStyle">
                    <div class="mb-3">
                        <span class="p-input-icon-left w-full">
                            <i class="pi pi-search" />
                            <InputText v-model="searchQuery" placeholder="Rechercher..." class="w-full p-inputtext-sm"
                                autofocus />
                        </span>
                    </div>
...
const icons = [
    'folder', 'folder-open', 'file', 'file-alt', 'clipboard', 'clipboard-list', 'clipboard-check',
    'check', 'check-circle', 'check-double', 'times', 'times-circle',
    'exclamation', 'exclamation-circle', 'exclamation-triangle', 'info', 'info-circle',
    'question', 'question-circle',
    'user', 'user-circle', 'users', 'user-plus', 'user-check', 'user-tie', 'user-graduate',
    'graduation-cap', 'book', 'book-open', 'bookmark',
    'calendar', 'calendar-alt', 'calendar-check', 'calendar-plus', 'clock',
    'building', 'home', 'industry', 'warehouse',
    'cog', 'cogs', 'tools', 'wrench', 'hammer',
    'chart-bar', 'chart-line', 'chart-pie', 'chart-area',
    'eye', 'eye-slash', 'search', 'filter', 'sort',
    'lock', 'lock-open', 'key', 'shield-alt',
    'envelope', 'paper-plane', 'inbox',
    'phone', 'mobile-alt',
    'map-marker-alt', 'globe', 'flag',
    'star', 'heart', 'thumbs-up', 'thumbs-down',
    'trash', 'trash-alt', 'edit', 'pen', 'pencil-alt',
    'save', 'download', 'upload', 'cloud',
    'link', 'unlink', 'external-link-alt',
    'list', 'list-ul', 'list-ol', 'th', 'th-large', 'th-list',
    'arrow-right', 'arrow-left', 'arrow-up', 'arrow-down',
    'sync', 'sync-alt', 'redo', 'undo',
    'plus', 'plus-circle', 'minus', 'minus-circle',
    'medkit', 'first-aid', 'heartbeat', 'stethoscope',
    'hard-hat', 'fire-extinguisher', 'biohazard'
]
