        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="field">
                ...
                <Select id="type" v-model="form.type" :options="typeOptions" optionLabel="label" optionValue="value"
                    class="w-full" :class="{ 'p-invalid': errors.type }" />
            ...
            <div class="field">
                ...
                <DatePicker id="date" v-model="form.date" dateFormat="dd/mm/yy" class="w-full"
                    :class="{ 'p-invalid': errors.date }" /> <small v-if="errors.date" class="text-red-500">{{
                        errors.date }}</small>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="field">
                    <label for="performer" class="block text-sm font-medium text-gray-700 mb-1">Intervenant *</label>
                    <InputText id="performer" v-model="form.performer" class="w-full"
                ...
                <div class="field">
                    ...
                    <InputNumber id="cost" v-model="form.cost" mode="currency" currency="EUR" locale="fr-FR"
                        class="w-full" />
                </div>
            </div>
            ...
            <div class="field">
                ...
                <Select id="result" v-model="form.result" :options="resultOptions" optionLabel="label"
                    optionValue="value" class="w-full" :class="{ 'p-invalid': errors.result }" /> <small
                    v-if="errors.result" class="text-red-500">{{ errors.result }}</small>
            </div>

            <div class="field">
                <label for="next_maintenance_date" class="block text-sm font-medium text-gray-700 mb-1">Prochaine
                    maintenance</label>
                <DatePicker id="next_maintenance_date" v-model="form.next_maintenance_date" dateFormat="dd/mm/yy"
                    class="w-full" />
            </div>
        </div>
