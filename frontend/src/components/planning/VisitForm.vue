<template>
    <div class="grid grid-cols-1 gap-4">
        ...
        <div class="field">
            ...
            <Select id="auditor" v-model="form.auditor_id" :options="users" optionLabel="fullname" optionValue="id"
                placeholder="Sélectionner un auditeur" class="w-full" :class="{ 'p-invalid': errors.auditor_id }"
                filter />
...
const save = async () => {
    ...
    try {
        if (props.visit) {
            ...
            toast.add({ severity: 'success', summary: 'Succès', detail: 'Visite mise à jour', life: 3000 })
        } else {
