    ...
    <div class="card">
        ...
        <DataTable :value="participations" stripedRows size="small">
            ...
            <Column header="Actions" :exportable="false" style="min-width: 8rem">
                <template #body="slotProps">
                    <Button icon="pi pi-pencil" text rounded severity="info" class="mr-2"
                        @click="editParticipation(slotProps.data)" v-tooltip="'Modifier le statut'">
                        <template #icon>
        ...
        <Dialog v-model:visible="dialogVisible"
            ...
            <div class="field" v-if="!editingParticipation">
                ...
                <Dropdown id="user" v-model="form.user_id" :options="users" optionLabel="fullname" optionValue="id"
