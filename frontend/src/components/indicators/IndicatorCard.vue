<template>
    <Card class="h-full shadow-sm hover:shadow-md transition-shadow cursor-pointer"
            ...
            <div class="flex flex-col gap-4">
                <div class="flex justify-between items-end">
                    <div class="flex flex-col">
                        ...
                        <span class="text-xl font-bold">{{ indicator.target_value }}
                ...
                <div class="h-32 w-full">
                    <Chart v-if="mounted" type="line" :data="chartData" :options="chartOptions" class="h-full" />
                </div>
            </div>
        </template>
    </Card>
